...
void Imprimir_LCD(void){
    ...
    Lcd_float(PT100);
    Lcd_Set_Cursor(3,1);
    Lcd_Write_String("INF1:");
    Lcd_float(AlarmaS1[0]);
    Lcd_Set_Cursor(3,9);
    Lcd_Write_String("SUP1:");
    Lcd_float(AlarmaS1[1]);
    Lcd_Set_Cursor(4,1);
    Lcd_Write_String("INF2:");
    Lcd_float(AlarmaS2[0]);
    Lcd_Set_Cursor(4,9);
    Lcd_Write_String("SUP2:");
    Lcd_float(AlarmaS2[1]);
}

void informacion(void){
    Arreglo[0]=estadoSwitch+'0';
    Arreglo[1]=((int)LM335/10)+'0';
    Arreglo[2]=((int)LM335%10)+'0';
    Arreglo[3]=((int)PT100/10)+'0';
    Arreglo[4]=((int)PT100%10)+'0';
    Arreglo[5]=AlarmaS1[0]+'0';
    Arreglo[6]=AlarmaS2[0]+'0';
    Arreglo[7]=AlarmaS1[1]+'0';
    Arreglo[8]=AlarmaS2[1]+'0';
}

void ComprobarALarmaS1(void){
        if(LM335<20){
            AlarmaS1[0]=1;AlarmaS1[1]=0;
        }
        else if(LM335>50){
            AlarmaS1[0]=0;AlarmaS1[1]=1;
        }
        else{
            AlarmaS1[0]=0;AlarmaS1[1]=0;
        }
}
void ComprobarALarmaS2(void){
        if(PT100<30){
            AlarmaS2[0]=1;AlarmaS2[1]=0;
        }
        else if(PT100>60){
            AlarmaS2[0]=0;AlarmaS2[1]=1;
        }
        else{
            AlarmaS2[0]=0;AlarmaS2[1]=0;
        }
}
    ...
    while (1)
    {
        ...
        switch(estadoSwitch){
            ...
            case 1:
                ...
                ValorADC[0]=ADC_GetConversion(channel_AN0);
                ADC_SelectChannel(channel_AN1);
                ValorADC[1]=ADC_GetConversion(channel_AN1);
                LM335=((ValorADC[0]*0.489)-273);
                PT100=( 0.526*ValorADC[1]-305.263);
