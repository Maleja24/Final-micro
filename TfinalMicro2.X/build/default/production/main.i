...
void Informacion(void){
        Arreglo[0]=RecibirDato_UART();
        Arreglo[1]=RecibirDato_UART();
        Arreglo[2]=RecibirDato_UART();
        Arreglo[3]=RecibirDato_UART();
        Arreglo[4]=RecibirDato_UART();
        Arreglo[5]=RecibirDato_UART();
        Arreglo[6]=RecibirDato_UART();
        Arreglo[7]=RecibirDato_UART();
        Arreglo[8]=RecibirDato_UART();
}
...
void main(void)
{
    ...
    while (1)
    {
        ...
        EnviarTexto_UART("SW:");
        EnviarDato_UART(Arreglo[0]);
        EnviarDato_UART('\n');
        EnviarDato_UART('\r');
        EnviarTexto_UART("LM:");
        EnviarDato_UART(Arreglo[1]);
        EnviarDato_UART(Arreglo[2]);
        EnviarTexto_UART("  PT:");
        EnviarDato_UART(Arreglo[3]);
        EnviarDato_UART(Arreglo[4]);
        EnviarDato_UART('\n');
        EnviarDato_UART('\r');
        EnviarTexto_UART("INF1: ");
        EnviarDato_UART(Arreglo[5]);
        EnviarTexto_UART("  SUP2: ");
        EnviarDato_UART(Arreglo[6]);
        EnviarDato_UART('\n');
        EnviarDato_UART('\r');
        EnviarTexto_UART("SUP1: ");
        EnviarDato_UART(Arreglo[7]);
        EnviarTexto_UART("  SUP2: ");
        EnviarDato_UART(Arreglo[8]);
        EnviarDato_UART('\n');
        EnviarDato_UART('\r');
    }
}
